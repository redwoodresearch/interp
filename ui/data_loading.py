...
import random
from interp.model.model_loading import RRFS_DIR
...
def get_val_seqs(train=False, n_files=2):
    data_dirname = (
        "/home/ubuntu/datasets/" if os.path.exists("/home/ubuntu/datasets/") else f"{RRFS_DIR}/pretraining_datasets/"
    )
    dirname = data_dirname + ("owt_tokens_int16" if train else "owt_tokens_int16_val")
...
def get_train_full_length_seqs(n_files=2):
    ...
    dirname = data_dirname + "owt_tokens_int16"
